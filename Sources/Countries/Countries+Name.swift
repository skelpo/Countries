extension Country {
    public init?(name: String) {
        ...
        case "Bouvet Island": self = .bouvetIsland
        ...
        case "Heard Island and Mcdonald Islands": self = .heardIslandAndMcdonaldIslands
        ...
        case "Niue": self = .niue
        case "Norfolk Island": self = .norfolkIsland
        ...
        case "South Georgia and The South Sandwich Islands": self = .southGeorgiaAndTheSouthSandwichIslands
        ...
        case "United States Minor Outlying Islands": self = .unitedStatesMinorOutlyingIslands
